...
exports.generateAdminRegistrationSuccessEmail = exports.generatePasswordResetSuccessEmail = exports.generateResetPasswordEmail = exports.sendVerificationSuccessEmail = exports.generateVerificationEmail = void 0;
...
const sendVerificationSuccessEmail = (name, email) => `
  <div style="font-family: Arial, sans-serif; max-width: 600px; margin: auto; padding: 24px; border-radius: 8px; background-color: #f1f4f6; color: #07131F;">
...
const generateResetPasswordEmail = (name, resetToken) => {
...
const generatePasswordResetSuccessEmail = (name) => {
    return `
    <div style="font-family: Arial, sans-serif; max-width: 600px; margin: auto; padding: 24px; border-radius: 8px; background-color: #f1f4f6; color: #07131F;">
...
exports.generatePasswordResetSuccessEmail = generatePasswordResetSuccessEmail;
// utils/emailTemplate.ts
const generateAdminRegistrationSuccessEmail = (name) => `
...
`;
exports.generateAdminRegistrationSuccessEmail = generateAdminRegistrationSuccessEmail;
